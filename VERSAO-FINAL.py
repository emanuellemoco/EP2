...
numerodeinspermons = 20 #QUANDO ADICIONAR INSPERMONS, MUDAR AQUI
...
while True:
	...
	if pergunta == "2":
		...
		print("{0} \nVida: {1}\nPoder: {2}\nDefesa: {3}\n".format(adversario["nome"], adversario["vida"], adversario["poder"], adversario["defesa"]))
		#print (adversario)
		print ("\n")
	...
	#	print(listainsperdex)
		for i in range(len(listainsperdex)):
			ipmon = listainsperdex[i]
			print("Nome:{0} \nvida: {1} \npoder: {2} \ndefesa: {3}\n".format( 
				ipmon["nome"], ipmon["vida"], ipmon["poder"], ipmon["defesa"]))
		print ("\n")
